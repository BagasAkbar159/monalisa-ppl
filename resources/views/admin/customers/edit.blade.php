        ...
        <form action="{{ route('admin.customers.update', $customer->id) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input
                    ...
                    id="phone"
                    name="phone"
                    value="{{ old('phone', $customer->phone ?? $customer->user->phone) }}"
            ...
            <div>
                ...
                >
                    <option value="0" {{ old('is_verified', $customer->is_verified) == 0 ? 'selected' : '' }}>Belum Terverifikasi</option>
                    <option value="1" {{ old('is_verified', $customer->is_verified) == 1 ? 'selected' : '' }}>Terverifikasi</option>
                </select>
                @error('is_verified')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
